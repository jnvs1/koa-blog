...
exports.createConnection = function createConnection(config) {
  const Connection = loadClass('Connection')
  const ConnectionConfig = loadClass('ConnectionConfig')
...
exports.createPool = function createPool(config) {
  const Pool = loadClass('Pool')
  const PoolConfig = loadClass('PoolConfig')
...
exports.createPoolCluster = function createPoolCluster(config) {
  const PoolCluster = loadClass('PoolCluster')
...
exports.escape = function escape(value, stringifyObjects, timeZone) {
  const SqlString = loadClass('SqlString')
 ...
 * @public
 */
export.format = function format(sql, values, stringifyObjects, timeZone) {
  const SqlString = loadClass('SqlString')
