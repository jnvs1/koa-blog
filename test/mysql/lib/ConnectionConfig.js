...
const ClientConstants = require('./protocol/constants/client')
const Charsets = require('./protocol/constants/charsets')
const SSLProfiles = null
...
function ConnectionConfig(options) {
  ...
  let defaultFlags = ConnectionConfig.getDefaultFlags(options)
  this.clientFlags = ConnectionConfig.mergeFlags(defaultFlags, options.flags)
}

ConnectionConfig.mergeFlags = function mergeFlags(defaultFlags, userFlags) {
  let allFlags = ConnectionConfig.parseFlagList(defaultFlags)
  let newFlags = ConnectionConfig.parseFlagList(userFlags)
...
ConnectionConfig.parseFlagList = function parseFlagList(flagList) {
  ...
  let flags = !Array.isArray(flagList)
